...
export default function ResumePage() {
    return (
        <div className="min-h-screen pt-32 pb-20 px-4 md:px-8 max-w-4xl mx-auto print:pt-0 print:pb-0 print:px-0 print:bg-white">
            ...
            `}</style>
            <Link to="/" className="inline-flex items-center text-zinc-400 hover:text-blue-400 mb-8 transition-colors print:hidden">
            ...
            >
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 border-b border-white/10 pb-8 gap-6">
                    <div>
                        ...
                        <h2 className="text-xl text-blue-400 font-medium tracking-wide">LinkedIn: <a href="https://www.linkedin.com/in/sanmaya-m-b-/" target="_blank" rel="noreferrer" className="text-white hover:text-blue-300">/in/sanmaya-m-b-</a></h2>
                        <h2 className="text-xl text-blue-400 font-medium tracking-wide mt-1">GitHub: <a href="https://github.com/sanmaaya" target="_blank" rel="noreferrer" className="text-white hover:text-blue-300">/sanmaaya</a></h2>
                    </div>
                    <div className="flex flex-col md:items-end gap-2 text-zinc-400">
                        <div className="flex items-center gap-2">
                            <span className="font-medium text-blue-400">Email:</span> sanmayabimal@gmail.com
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="font-medium text-blue-400">Mobile:</span> +91 8075230575
                        </div>
                        <button onClick={() => window.print()} className="mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-full font-medium flex items-center gap-2 hover:scale-105 transition-all shadow-[0_0_20px_rgba(59,130,246,0.3)] print:hidden">
                ...
                <div className="space-y-12">
                    ...
                    <section>
                        <h3 className="text-2xl font-semibold mb-6 flex items-center gap-3">
                            <span className="p-2 bg-blue-500/10 rounded-lg text-blue-400"><Code2 className="w-5 h-5" /></span> SKILLS
                        </h3>
                    ...
                    <section>
                        ...
                        <div className="space-y-8">
                            <div className="relative pl-6 border-l border-zinc-800">
                                ...
                                <p className="text-blue-400 text-sm mb-4 tracking-wide font-medium">Forage | GitHub</p>
                            ...
                            <div className="relative pl-6 border-l border-zinc-800">
                                ...
                                <p className="text-blue-400 text-sm mb-4 tracking-wide font-medium">AWS | Forage</p>
                                <ul className="list-disc list-outside ml-5 text-zinc-400 space-y-2 leading-relaxed text-lg">
                    ...
                    <section>
                        ...
                        <div className="space-y-10">
                            <div className="relative pl-6 border-l border-zinc-800">
                                ...
                                <p className="text-blue-400 text-sm mb-4 tracking-wide font-medium">Full Stack Development | GitHub</p>
                                <ul className="list-disc list-outside ml-5 text-zinc-400 space-y-2 leading-relaxed text-lg">
                            ...
                            <div className="relative pl-6 border-l border-zinc-800">
                                ...
                                <p className="text-blue-400 text-sm mb-4 tracking-wide font-medium">Web Development (Client Project) | GitHub</p>
                                <ul className="list-disc list-outside ml-5 text-zinc-400 space-y-2 leading-relaxed text-lg">
                            ...
                            <div className="relative pl-6 border-l border-zinc-800">
                                ...
                                <p className="text-blue-400 text-sm mb-4 tracking-wide font-medium">Web + AI Integration | GitHub</p>
                                <ul className="list-disc list-outside ml-5 text-zinc-400 space-y-2 leading-relaxed text-lg">
                    ...
                    <section>
                        ...
                        <div className="space-y-8">
                            <div className="relative pl-6 border-l border-zinc-800">
                                ...
                                <h4 className="text-xl font-medium text-white mb-1 whitespace-pre-wrap">From Data to Decisions: A Hands-On Approach to Data Science <span className="text-blue-400 text-base font-normal">| Certificate</span></h4>
                                ...
                                <div className="mt-6 bg-white/5 rounded-2xl p-6 border border-white/5 shadow-inner">
                                    ...
                                    <p className="text-blue-400 text-sm mb-5 tracking-wide font-medium">NLP, Machine Learning, Power BI | GitHub</p>
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-col sm:flex-row justify-between sm:items-center py-3 border-b border-white/5 group hover:bg-white/5 px-2 rounded-lg transition-colors">
                                <div className="text-zinc-200 text-lg font-medium group-hover:text-blue-300 transition-colors print:font-bold">HackerRank Verified Skills <span className="text-blue-500/50 text-base font-normal ml-1">| HackerRank</span></div>
                                <div className="text-zinc-500 text-sm mt-1 sm:mt-0 italic">JavaScript (Basic), CSS (Basic)</div>
                            </div>
                            <div className="flex flex-col sm:flex-row justify-between sm:items-center py-3 border-b border-white/5 group hover:bg-white/5 px-2 rounded-lg transition-colors">
                                <div className="text-zinc-200 text-lg font-medium group-hover:text-blue-300 transition-colors print:font-bold">Cloud Computing <span className="text-blue-500/50 text-base font-normal ml-1">| NPTEL</span></div>
                                <div className="text-zinc-500 text-sm mt-1 sm:mt-0">Nov '25</div>
                            </div>
                            <div className="flex flex-col sm:flex-row justify-between sm:items-center py-3 border-b border-white/5 group hover:bg-white/5 px-2 rounded-lg transition-colors">
                                <div className="text-zinc-200 text-lg font-medium group-hover:text-blue-300 transition-colors print:font-bold">Backend Web Development (Node.js & Express) <span className="text-blue-500/50 text-base font-normal ml-1">| DevTown</span></div>
                            ...
                            <div className="flex flex-col sm:flex-row justify-between sm:items-center py-3 border-b border-white/5 group hover:bg-white/5 px-2 rounded-lg transition-colors border-b-0">
                                <div className="text-zinc-200 text-lg font-medium group-hover:text-blue-300 transition-colors print:font-bold">Advanced Excel, Tableau & Power BI — Certificate of Merit <span className="text-blue-500/50 text-base font-normal ml-1 whitespace-nowrap">| LPU</span></div>
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-col md:flex-row justify-between md:items-center py-4 border-b border-white/5 gap-4 group hover:bg-white/5 px-2 rounded-lg transition-colors">
                                <div className="text-zinc-400 leading-relaxed text-lg group-hover:text-zinc-300 transition-colors">Solved 200+ coding problems across competitive programming platforms like <span className="text-blue-400 font-medium">LeetCode</span>, <span className="text-blue-400 font-medium">HackerRank</span> and <span className="text-blue-400 font-medium">GeeksforGeeks</span>.</div>
                                <div className="text-zinc-500 text-sm whitespace-nowrap">Nov '25</div>
                            </div>
                            <div className="flex flex-col md:flex-row justify-between md:items-center py-4 border-b border-white/5 gap-4 group hover:bg-white/5 px-2 rounded-lg transition-colors">
                                <div className="text-zinc-400 leading-relaxed text-lg group-hover:text-zinc-300 transition-colors">Earned multiple <span className="text-blue-400 font-medium">HackerRank</span> skill badges, including C++ (4 Star), Java, 30 Days of Code and C language.</div>
                                <div className="text-zinc-500 text-sm whitespace-nowrap">Nov '25</div>
                            </div>
                        </div>
                    </section>
