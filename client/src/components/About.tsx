            ...
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    <div className="space-y-6 text-lg text-zinc-300 leading-relaxed font-medium">
                        <p>
                            I am a B.Tech Computer Science student at <strong className="text-white font-bold font-medium">Lovely Professional University</strong>, currently focused on Full Stack Web Development. I enjoy designing and developing web applications that are both functional and visually intuitive.
                        </p>
                        <p>
                        ...
                        <div className="flex flex-wrap gap-4 mt-8 pt-6 border-t border-white/10">
                            <div className="flex items-center gap-3 bg-red-600/5 px-4 py-2.5 rounded-xl border border-red-600/10 hover:bg-red-600/10 transition-colors">
                                ...
                                <span className="text-sm font-semibold text-zinc-200">Kozhikode, Kerala (India)</span>
                            </div>
                            <div className="flex items-center gap-3 bg-white/10/80 px-4 py-2.5 rounded-xl border border-white/10 hover:bg-white/20/80 transition-colors">
                                <div className="p-1.5 bg-white/20 rounded-lg">
                                    <Languages className="w-4 h-4 text-zinc-200" />
                                </div>
                                <span className="text-sm font-semibold text-zinc-200">English, Malayalam, Hindi</span>
                            </div>
                        </div>
                    </div>
                        ...
                        {cards.map((card, idx) => (
                            ...
                            >
                                ...
                                <div className="relative h-full w-full glass-panel p-6 rounded-2xl hover:bg-white/5 transition-colors cursor-default">
                                    ...
                                    <p className="text-sm text-zinc-300 leading-relaxed">{card.desc}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
