        ...
        <section id="certifications" className="section-padding relative">
            ...
            >
                <div className="flex items-center gap-4 mb-16">
                    <h2 className="heading-2 m-0 text-white font-bold">Certifications & <span className="text-red-600">Badges.</span></h2>
                                    ...
                                    <div className="p-6 flex flex-col flex-1">
                                        <div className="flex items-start gap-4 mb-6 mt-1">
                                            ...
                                            <div>
                                                ...
                                                <h3 className="text-lg font-bold text-white font-bold group-hover:text-red-500 transition-colors line-clamp-2 leading-tight">
                                                    {cert.title}
                                                </h3>
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-3 flex-1">
                                            {cert.details.map((detail, i) => (
                                                <div key={i} className="flex items-start gap-2.5">
                                                    ...
                                                    <span className="text-zinc-300 text-xs leading-relaxed group-hover:text-zinc-200 font-medium transition-colors">
                                                        {detail}
                                                    </span>
                                                </div>
                                            ))}
                                        ...
                                        <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
                                            <span className="text-[10px] font-semibold text-zinc-400 uppercase tracking-widest flex items-center gap-2">
                ...
                {certs.length > 3 && (
                    <div className="mt-12 flex justify-center">
                        <motion.button
                            ...
                            className="group relative px-6 py-3 bg-white/5 border border-white/10 rounded-xl flex items-center gap-3 text-white font-bold font-bold hover:bg-red-600 transition-all hover:border-red-500 overflow-hidden"
                        >
