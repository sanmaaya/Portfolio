                            ...
                            >
                                ...
                                <div className="glass-panel p-5 md:p-6 rounded-3xl hover:border-red-600/30 transition-all flex flex-col gap-4">
                                    <div>
                                        ...
                                        <h3 className="text-xl font-bold mb-1.5 text-white font-bold">{item.degree}</h3>
                                        <div className="text-base text-zinc-300 font-medium">{item.institution}</div>
                                    </div>

                                    <div className="mt-2 pt-4 border-t border-white/10">
                                        <h4 className="text-xs font-medium text-zinc-400 mb-3 uppercase tracking-wider">Relevant Focus Areas</h4>
                                        <div className="flex flex-wrap gap-2">
                                            {item.focus.map((f, i) => (
                                                <span key={i} className="px-3 py-1.5 bg-white/5 rounded-full text-xs font-medium text-zinc-200 font-medium border border-white/10 hover:bg-white/10 transition-colors cursor-default">
                                                    {f}
                                                </span>
                                            ))}
                                        </div>
