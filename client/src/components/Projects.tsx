                ...
                {projects.length > 3 && (
                    <div className="mt-16 flex justify-center">
                        <motion.button
                            ...
                            className="group relative px-8 py-4 bg-slate-100/50 border border-slate-200 rounded-2xl flex items-center gap-3 text-slate-900 font-bold font-bold hover:bg-red-600 transition-all hover:border-red-500 overflow-hidden shadow-2xl"
                        >
                            ...
                            <div className="mt-10 flex flex-wrap items-center gap-4 pt-6 border-t border-slate-200">
                                ...
                                {selectedProject.live && (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex-1 min-w-[140px] flex items-center justify-center gap-2 py-3.5 rounded-xl bg-red-700 border border-red-600 hover:bg-red-600 transition-all text-sm font-bold text-slate-900 font-bold group shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)]"
                                    >
