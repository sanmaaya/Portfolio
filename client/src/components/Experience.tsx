        ...
        <section id="experience" className="section-padding relative">
            ...
            >
                <div className="flex items-center gap-4 mb-16">
                    ...
                    <h2 className="heading-2 m-0 text-right">Virtual Experience & Internships<span className="text-pink-500">.</span></h2>
                </div>
                ...
                <div className="relative border-l border-zinc-800 ml-4 md:ml-0 md:pl-8 space-y-12">
                    {experiences.map((exp, idx) => (
                        ...
                        >
                            {/* Timeline dot */}
                            <div className="absolute w-4 h-4 rounded-full bg-pink-500 border-4 border-background -left-[1.35rem] md:-left-[2.5rem] mt-1.5 z-10" />
                                ...
                                <div className="relative glass-panel p-8 rounded-3xl hover:bg-white/[0.02] transition-colors">
                                    <div className="flex flex-col md:flex-row md:items-baseline md:justify-between mb-4">
                                        <div>
                                            ...
                                            <div className="text-pink-400 font-medium text-lg mt-1">{exp.company}</div>
                                        </div>
                                    ...
                                    <div className="flex flex-col lg:flex-row gap-8 mt-4">
                                        ...
                                        {exp.certificate && (
                                            <div className="relative group/cert rounded-xl overflow-hidden border border-white/10 w-full lg:w-80 shadow-2xl shrink-0 self-start">
                                                <div className="absolute inset-0 bg-pink-500/10 opacity-0 group-hover/cert:opacity-100 transition-opacity z-10 pointer-events-none" />
                                                <img 
                                                    src={exp.certificate} 
