    ...
    return (
        <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 flex flex-col items-center text-center">
                ...
                <motion.h2
                    className="text-2xl md:text-3xl font-light text-zinc-400 mb-6 max-w-3xl leading-relaxed"
                    initial={{ opacity: 0, y: 30 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, delay: 0.4, ease: "easeOut" }}
                >
                    Full Stack Developer | Building Scalable and User-Focused <span className="text-white font-medium">Web Applications</span>
                </motion.h2>

                <motion.p
                    className="text-lg text-zinc-500 mb-10 max-w-2xl"
                ...
                >
                    <ScrollLink
                        ...
                        offset={-100}
                        duration={500}
                        className="group px-8 py-4 bg-white text-black rounded-full font-semibold flex items-center gap-3 hover:scale-105 transition-all cursor-pointer shadow-[0_0_20px_rgba(255,255,255,0.2)]"
                    >
                        View Projects <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                    </ScrollLink>
                    <Link
                        to="/resume"
                        className="px-8 py-4 bg-white/5 border border-white/10 rounded-full font-medium flex items-center gap-3 hover:bg-white/10 hover:border-white/20 transition-all cursor-pointer"
                    >
